...
document.addEventListener("DOMContentLoaded", function () {
  addPopupListeners("PopUpEve", "EveClose", "EveOK");
  addPopupListeners("PopUpHighkey", "HighkeyClose", "HighkeyOK");
  addPopupListeners("PopUpFei", "FeiClose", "FeiOK");
  addPopupListeners("PopUpHoz", "HozClose", "HozOK");
  addPopupListeners("PopUpArch", "ArchClose", "ArchOK");
  addPopupListeners("PopUpRtx", "RtxClose", "RtxOK");
});
